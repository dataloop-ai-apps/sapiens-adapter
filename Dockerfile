...
# docker build --no-cache -t gcr.io/viewo-g/piper/agent/runner/apps/sapiens-adapter:0.0.5 -f Dockerfile .
# docker run -it gcr.io/viewo-g/piper/agent/runner/apps/sapiens-adapter:0.0.5 bash
# docker push gcr.io/viewo-g/piper/agent/runner/apps/sapiens-adapter:0.0.5
